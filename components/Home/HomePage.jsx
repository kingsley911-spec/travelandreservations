  ...
  return (
    <div>
      ...
      <div className="holiday-section">
        ...
        <h5 className="holiday-title">Our holidays are more enjoyable because they do good</h5>
      ...
      <div className="holiday-content">
        <center>
          <h5 className="holiday-header">Holidays</h5>
        </center>

        <div className="holiday-grid">
          <div className="holiday-card">
            <img src="image/sri lanka image.jpg" alt="Sri Lanka highlights tour" />
            <h3><a style={{color: "#FF4500"}} href="#">Sri Lanka highlights tour</a></h3>
          ...
          <div className="holiday-card">
            ...
            <h3><a style={{color: "#FF4500"}} href="#">Atlas Mountains trekking</a></h3>
          ...
          <div className="holiday-card">
            ...
            <h3><a style={{color: "#FF4500"}} href="#">Cambodia adventure</a></h3>
          ...
          <div className="holiday-card">
            ...
            <h3><a style={{color: "#FF4500"}} href="#">Botswana & Victoria Falls</a></h3>
          ...
          <div className="holiday-card">
            ...
            <h3><a style={{color: "#FF4500"}} href="#">Azores whale watching</a></h3>
          ...
          <div className="holiday-card">
            ...
            <h3><a style={{color: "#FF4500"}} href="#">Rajasthan cycling holiday</a></h3>
          ...
          <div className="holiday-card">
            ...
            <h3><a style={{color: "#FF4500"}} href="#">Inspiration for solo travellers</a></h3>
          ...
          <div className="holiday-card">
            ...
            <h3><a style={{color: "#FF4500"}} href="#">Walking holidays</a></h3>
          ...
          <div className="holiday-card">
            ...
            <h3><a style={{color: "#FF4500"}} href="#">Spotlight on: Costa Rica</a></h3>
            <p>Volcano-view hikes, turtle beaches, and conservation-supporting lodges.</p>
          </div>
        </div>
      </div>

      <div className="travel-team-section">
      ...
      <div className="loan">
        ...
        <div className="olive">
          <div className="card">
            ...
            <h3><a style={{color: "#FF4500"}} href="#">About us in 60 seconds</a></h3>
          ...
          <div className="card">
            ...
            <h3><a style={{color: "#FF4500"}} href="#">What is Travel + Reservation?</a></h3>
          ...
          <div className="card">
            ...
            <h3><a style={{color: "#FF4500"}} href="#">Reviews</a></h3>
          ...
          <div className="card">
            ...
            <h3><a style={{color: "#FF4500"}} href="#">Meet our founder, Justin</a></h3>
      ...
      <div className="intro-section">
        <center>
          <h1><a style={{color: "#FF4500"}} href="#">Travel + Reservation</a></h1>
      ...
      <div className="rating-section">
        <div className="rating">
          <span className="stars" title="5 star rating">
            <i className="fa-solid fa-star"></i>
            <i className="fa-solid fa-star"></i>
            <i className="fa-solid fa-star"></i>
            <i className="fa-solid fa-star"></i>
            <i className="fa-solid fa-star"></i>
            <span className="star-text">5 STAR</span>
          </span>
          <div className="progress">
            <div className="progress-bar w-9/12" >75%</div>
          </div>
        </div>

        <div className="rating">
          <span className="stars" title="4 star rating">
            <i className="fa-solid fa-star"></i>
            <i className="fa-solid fa-star"></i>
            <i className="fa-solid fa-star"></i>
            <i className="fa-solid fa-star"></i>
            <span className="star-text">4 STAR</span>
          </span>
          <div className="progress">
            <div className="progress-bar w-1/4" >25%</div>
          </div>
        </div>

        <div className="rating">
          <span className="stars" title="3 star rating">
            <i className="fa-solid fa-star"></i>
            <i className="fa-solid fa-star"></i>
            <i className="fa-solid fa-star"></i>
            <span className="star-text">3 STAR</span>
          </span>
          <div className="progress">
            <div className="progress-bar w-[4%]" >4%</div>
          </div>
        </div>

        <div className="rating">
          <span className="stars" title="2 star rating">
            <i className="fa-solid fa-star"></i>
            <i className="fa-solid fa-star"></i>
            <span className="star-text">2 STAR</span>
          </span>
          <div className="progress">
            <div className="progress-bar w-[1.7%]" >1.7%</div>
          </div>
        </div>

        <div className="rating">
          <span className="stars" title="1 star rating">
            <i className="fa-solid fa-star"></i>
            <span className="star-text">1 STAR</span>
          </span>
          <div className="progress">
            <div className="progress-bar w-[1%]" >1%</div>
          </div>
        </div>
      </div>
      ...
      <div className="media-quotes">
        <div className="quote">
          ...
          <img src="image/guardianimage.svg" alt="The Guardian logo" />
        </div>

        <div className="quote">
          <h4><i>"Great source of travel ideas by a spokesperson for responsible tourism"</i></h4>
          <img src="image/new-york-timesimage.svg" alt="The New York Times logo" />
        </div>
      ...
      <div className="footer">
        <div className="sub-footer">
          ...
          <a className="top-link" id="top-link" href="#top" title="Back to the top">
            <i className="fa fa-angle-double-up"></i> Back to the top
          </a>
        </div>
      </div>
    </div>
